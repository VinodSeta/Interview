...
using FullStackDevExercise.Repository;
...
namespace FullStackDevExercise
{
  public class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      #region DbContext
      services.AddDbContext<DoLittleDb>(options => options.UseSqlite("Data Source=./dolittle.db"));
      #endregion
      ...
      services.AddScoped<IPetService, PetRepository>();
